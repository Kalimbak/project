...
type LeftSidebarResponsiveProps = {
  className?: string;
  closeSidebar: () => void;
};
...
const LeftSidebarResponsive: FC<LeftSidebarResponsiveProps> = ({ closeSidebar }) => {
  return (
    <div>
      <SidebarResponsive className="sidebar-responsive-menu">
        ...
        <div className="sidebar-responsive-contents">
...
export default LeftSidebarResponsive;
